    ...
    <main className="mx-auto max-w-5xl px-6">
      <header className="rise-in pb-6 pt-14">
        ...
        <p className="mt-3 max-w-2xl text-[16px] text-ink-soft">
          {entries.length.toLocaleString()} English words from real psychometric exams and our reading passages, with their
          Hebrew meaning. Tap ♪ to hear a word, or listen to them all in <a href="/listen" className="link">Listen</a>.
        </p>
      </header>
