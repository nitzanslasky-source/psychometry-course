...
Q(0, 'vb-inf_v2_0409', [
 ...
 ('By understanding', [
  "A 'no' to which question lets us be certain that every student who does not like playing football was born in the summer?",
  D("Underline 'every student who does not like playing football' and 'was born in the summer'"),
  "That's the claim we want: every student who doesn't like football was born in the summer.",
  "Choice 1: students who like football. Someone who likes football? The claim says nothing about them. A 'no' here proves nothing. Out.",
  D("Cross out choice 1"),
  "Choice 4: not born in the summer — but they like football. Football lovers again. Out.",
  D("Cross out choice 4"),
  "Choice 2: born in the summer and don't like football. Those students just fit the claim — whether they exist or not, it proves nothing. Out.",
  D("Cross out choice 2"),
 ]),
 ('With arrows', [
  "Now the technique. Here understanding is enough — but as questions get harder, arrows make the data much easier to see.",
  A("not football → summer appears", P('not like football   →   born in summer', size=38)),
  D("Write 'condition' under 'not like football' and 'result' under 'born in summer'"),
  "Condition before the arrow, result after it.",
  "Likes football — that's not-condition: I know nothing. Born in the summer — that's the result: I know nothing.",
  A("condition ✓ + result ✗ = the only student who breaks it appears", P('not football   +   not summer   =   the only one who breaks it', size=34)),
  "The only student who can break the claim: condition yes, result no. Choice 3 asks exactly about him. A 'no' — and the claim is certain.",
  D("Circle choice 3"),
  "Choice 3.",
 ]),
 ('Flip and negate', [
  ...
  A("not summer → likes football appears", P('not born in summer   →   likes football', size=36)),
  "Flip and negate: not born in the summer leads to likes football. Same claim — and choice 3's student breaks it from this side too.",
...
Q(3, 'vb-inf_v2_0412', [
 ...
 ('What the datum says', [
  "Given: the wombats are a family of nocturnal marsupials common in Australia. Which question can be answered on the basis of the datum?",
  "Strange — we're not asked what follows. We're asked which question the datum can answer.",
  A("wombat → nocturnal marsupial, common in Australia appears", P('wombat   →   nocturnal marsupial, common in Australia', size=36)),
  "As an arrow: if it's a wombat, then it's a nocturnal marsupial common in Australia.",
  "But careful. How should we read a rule like that?",
  A("If there IS a wombat → ... appears", P('If there IS a wombat   →   it is a nocturnal Australian marsupial', size=34)),
 ...
 ('A rule is not existence', [
  ...
  "Here the datum gives us more than a rule. It talks about a real family: the wombats ARE common in Australia. They exist.",
  D("Underline 'the wombats are a family' and 'common in Australia'"),
  "And because they exist, we have a real example in our hands.",
 ]),
 ('The answer', [
  "Choice 1: is it the case that no nocturnal mammal common in Australia is a marsupial?",
  A("'No' → nocturnal Australian mammal → not a marsupial appears", P("'No'  →  nocturnal Australian mammal   →   not a marsupial", size=34)),
  "But the wombats exist — nocturnal, common in Australia, and marsupials, which are mammals. So the answer is: no, it isn't the case. We can answer it.",
  D("Circle choice 1"),
  "Choice 1.",
  "Choice 4 — does every nocturnal Australian marsupial belong to the wombats? That's the result pointing back at the condition. We know nothing.",
  D("Cross out choice 4"),
  "Choices 2 and 3 — other continents, other families. The datum says nothing about them.",
...
Q(6, 'vb-inf_v2_0404', [
 ...
 ('Link the claims', [
  "Ten children at the stop of bus 66. Every child who wore sports shoes boarded the bus. Every child who boarded the bus lives in Savyonim.",
  A("sports shoes → boarded appears", P('sports shoes   →   boarded the bus', size=38)),
  A("boarded → lives in Savyonim appears", P('boarded the bus   →   lives in Savyonim', size=38)),
  "Shoes here, the village there — they're split between two givens. We need to chain them.",
  "To chain, we need a term that appears in both claims. Boarded the bus.",
  D("Circle 'boarded the bus' in both givens"),
 ]),
 ('Read the chain', [
  A("sports shoes → boarded → Savyonim appears", P('sports shoes   →   boarded   →   lives in Savyonim', size=34)),
  "Sports shoes gives boarded, boarded gives Savyonim. Every child in sports shoes lives in Savyonim.",
  "Which is NOT possible? Choice 3: sports shoes and Savyonim — that's the chain from start to end. Possible.",
  D("Cross out choice 3"),
  "Choices 2 and 4: sandals. Not sports shoes — that's not-condition. We know nothing. Possible.",
  D("Cross out choices 2 and 4"),
 ]),
 ('Backwards too', [
  "And just like a single claim, you can run the whole chain backwards with negation.",
  A("not Savyonim → not boarded → no sports shoes appears", P('not Savyonim   →   did not board   →   no sports shoes', size=34)),
  "Lives in Shikmim — not Savyonim — so didn't board, so no sports shoes.",
  "Choice 1: wore sports shoes and lives in Shikmim. The backward chain says that can't happen.",
  D("Circle choice 1"),
  "Choice 1.",
