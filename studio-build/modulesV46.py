...
guided(4, 'vb-inf_mix_0072', GT, SBQ,
 ["A sample question — easy.", "A new way to weaken: don't argue with the conclusion — attack what it rests on."],
 [('Read the claim', [
   "Ariel read that dozens of studies found a link between drinking large quantities of rose tea and better health — and only two didn't.",
   "His conclusion: if he drinks a lot of rose tea, his health will improve.",
   D("Underline: dozens of studies … only two studies"),
   "His conclusion rests on those studies. That's its basis.",
   "Which does NOT weaken it? Find the three that weaken.",
  ]),
  ('Attack the basis', [
   "Choice one: researchers tend to shelve studies that don't show the link they wanted.",
   "So 'dozens against two' isn't a fair count — the studies that found nothing were never published.",
   ...
   D("Cross out choice 1"),
   "Choice two: most of the studies that found the link were funded by rose-tea producers. The data is shaky again. It weakens.",
   D("Cross out choice 2"),
   "Choice three: the studies that found no link appeared in more reliable journals. Again the basis is shaky. It weakens.",
   D("Cross out choice 3"),
  ]),
  ('What remains', [
   "Choice four: the studies that found no link were conducted before the others.",
   "When they were conducted says nothing about whether they're right. Irrelevant.",
   D("Circle choice 4"),
   "Choice four.",
